    ...
    if(upPressed){
      ...
      //coin collision test
       ...
       if(poopY + dpy < 0) {
        ...
        /*  if(poopX + dpx < canvas.width - 60 ) { poopX += dpx ;}
                 else if (poopX + dpx > 0){ poopX -= dpx;}

                  if(poopY + dpY < canvas.height - 60 ) { poopY += dpy ;}

                 else if (poopY + dpy > 0){ poopY -= dpy;}*/
